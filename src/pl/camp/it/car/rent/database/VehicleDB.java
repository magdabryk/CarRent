...
public class VehicleDB {
    ...
    public VehicleDB() {
        this.vehicles[0] = new Car("Audi", "A3", 2005, "KR11", 300.00);
        this.vehicles[1] = new Car("BMW", "3", 2006, "KR22", 250.00);
        this.vehicles[2] = new Car("Toyota", "Corolla", 2010, "KR33", 200.00);
        this.vehicles[3] = new Car("Mercedes", "C", 2020, "KR44", 500.00);
        this.vehicles[4] = new Car("Kia", "Ceed", 2011, "KR55", 300.00);
        this.vehicles[5] = new Bus("Solaris", "2000", 2010, "KR66", 500.00, 52);
        this.vehicles[6] = new Bus("Solaris", "3000", 2011, "KR77", 550.00, 62);
        this.vehicles[7] = new Motorcycle("Suzuki", "mz700", 2022, "KR99", 120.00, true);
    }
